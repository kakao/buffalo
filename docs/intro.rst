...
The Stream data format consists of two files:
  ...
  - uid
    ...
    - Each line is representational value of a user corresponding to each row in the MAIN file (e.g. user name)
